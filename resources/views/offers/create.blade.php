...
<head>
    ...
    <style>
        ...
        .offer-header .offer-header-revize-field {
            background: transparent !important;
            padding: 0 !important;
            min-height: 0;
        }
        ...
        .offer-header .offer-header-compact-field {
            width: 260px;
            flex: 0 0 260px;
        }
        .offer-header .offer-header-company-box {
            width: 520px;
            flex: 0 0 520px;
        }
        ...
        .offer-header .offer-header-revize-field .small-btn {
            background: #ffffff !important;
        }
        .offer-header-gray-input,
        #gecen_sure {
            background: #f3f4f6 !important;
        }
        #gecen_sure {
        ...
        .offer-header-fixed-label,
        .offer-header label[for="gecen_sure"],
        .offer-header label[for="gerceklesme_olasiligi"],
        .offer-header label[for="proje_turu_id"] {
            min-width: 120px !important;
        }
        .offer-header-short-select,
...
<div class="dashboard-container">
    ...
    <div class="offer-header">
        <div class="offer-header-left">
            <div class="offer-header-row">
                <div class="form-group">
                    ...
                    <input id="teklif_no" name="teklif_no" type="text" class="offer-header-gray-input" style="text-align:left;" value="{{ old('teklif_no', isset($teklif) ? $teklif->teklif_no : ($nextTeklifNo ?? '')) }}" readonly>
                </div>
                <div class="form-group">
                    <label for="revize_no" style="color:#9ca3af;">Revize No:</label>
                    <div class="input-with-button offer-header-revize-field" style="gap:0.25rem;">
            ...
            <div class="offer-header-row">
                ...
                <div class="form-group">
                    <label for="islem_turu_adi" style="color:#9ca3af;">Teklif Türü:</label>
            ...
            <div class="offer-header-row">
                <div class="form-group">
                    ...
                    <div id="firma_il_ilce" class="offer-header-company-box">
                        {{ isset($selectedFirm)
            ...
            <div class="offer-header-row">
                ...
                <div class="form-group" style="display:none;">
                    ...
                    <input id="hazirlayan_old" type="hidden" value="{{ old('hazirlayan', isset($teklif) ? $teklif->hazirlayan : '') }}">
                </div>
            </div>
        ...
        <div class="offer-header-right">
            ...
            <div class="form-group">
                ...
                <input id="hazirlayan" name="hazirlayan" type="text" class="offer-header-gray-input" value="{{ old('hazirlayan', isset($teklif) ? $teklif->hazirlayan : '') }}" style="border:none;background:transparent;outline:none;padding:0;" readonly>
            </div>
            <div class="form-group">
    ...
    <div id="islemTuruModal" class="modal-overlay">
        <div class="modal">
            <div class="modal-header">
                <div class="modal-title">Teklif Turu Sec</div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function buildOfferPrintPayload() {
            var header = {
                ...
                satis_temsilcisi: (document.getElementById('satis_temsilcisi')?.value || '').toString(),
