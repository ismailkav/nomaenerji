                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <div style="display:flex;gap:0.5rem;align-items:center;">
                                    <input type="text" id="satis_fiyat" name="satis_fiyat" value="{{ old('satis_fiyat', 0) }}" required style="flex:1 1 auto;width:auto;">
                                    @php($satisDoviz = old('satis_doviz', 'TL'))
                            ...
                            <div class="form-group" style="display:flex;align-items:center;gap:0.5rem;margin-top:1.6rem;">
                                ...
                                <input type="checkbox" id="multi" name="multi" value="1" {{ old('multi') ? 'checked' : '' }}>
                            </div>

                            <div class="form-group" style="display:flex;align-items:center;gap:0.5rem;margin-top:1.6rem;">
                                <label for="montaj">Montaj</label>
                                <input type="checkbox" id="montaj" name="montaj" value="1" {{ old('montaj') ? 'checked' : '' }}>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="prm1" name="prm1" value="{{ old('prm1') }}">
                                @error('prm1')<div class="form-error">{{ $message }}</div>@enderror
                            </div>

                            <div class="form-group">
                                <label for="prm2">Prm2</label>
                                <input type="text" id="prm2" name="prm2" value="{{ old('prm2') }}">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="fatura_kodu" name="fatura_kodu" value="{{ old('fatura_kodu') }}">
                                @error('fatura_kodu')<div class="form-error">{{ $message }}</div>@enderror
                            </div>

                            <div class="form-group">
                                <label for="marka">Marka</label>
                                <input type="text" id="marka" name="marka" value="{{ old('marka') }}">
...
<script>
    (function () {
        ...
        var selectedSubGroupId = @json((string)old('urun_alt_grup_id'));
        var selectedDetailGroupId = @json((string)old('urun_detay_grup_id'));
