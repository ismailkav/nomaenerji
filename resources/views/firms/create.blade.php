...
<head>
    ...
    <title>Yeni Firma - NomaEnerji</title>
    ...
    <main class="main-content">
        <header class="main-header form-header">
            <div class="form-header-left" style="display:flex;align-items:center;gap:0.75rem;">
                ...
                <div>
                    <h1 class="page-title">Yeni Firma</h1>
                    <p class="page-subtitle">Sisteme yeni bir firma ekleyin.</p>
                </div>
            </div>
            <div class="form-header-actions">
                <a href="{{ route('firms.index') }}" class="form-header-btn cancel">İptal</a>
                <button type="submit" form="firmForm" class="form-header-btn save">Kaydet</button>
            </div>
        </header>

        <section class="content-section">
            <div class="form-page-card">
                <form id="firmForm" action="{{ route('firms.store') }}" method="POST" class="form form-firm">
                    @csrf
                    ...
                    <div class="form-grid">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="carikod" name="carikod" value="{{ old('carikod') }}" required>
                            ...
                            <select id="cari_kategori_id" name="cari_kategori_id">
                                ...
                                @isset($categories)
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ (string)old('cari_kategori_id') === (string)$category->id ? 'selected' : '' }}>
                                            {{ $category->ad }}
                                        </option>
                                    @endforeach
                                @endisset
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="cariaciklama" name="cariaciklama" value="{{ old('cariaciklama') }}" required>
                            @error('cariaciklama')<div class="form-error">{{ $message }}</div>@enderror
                        </div>

                        <div class="form-group">
                            <label for="adres1">Adres 1</label>
                            <input type="text" id="adres1" name="adres1" value="{{ old('adres1') }}">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="ulke" name="ulke" value="{{ old('ulke') }}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="web_sitesi" name="web_sitesi" value="{{ old('web_sitesi') }}">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="iskonto1" name="iskonto1" value="{{ old('iskonto1', 0) }}">
                                @error('iskonto1')<div class="form-error">{{ $message }}</div>@enderror
                            </div>

                            <div class="form-group">
                                <label for="iskonto2">İskonto 2</label>
                                <input type="text" id="iskonto2" name="iskonto2" value="{{ old('iskonto2', 0) }}">
                                @error('iskonto2')<div class="form-error">{{ $message }}</div>@enderror
                            </div>

                            <div class="form-group">
                                <label for="iskonto3">İskonto 3</label>
                                <input type="text" id="iskonto3" name="iskonto3" value="{{ old('iskonto3', 0) }}">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="iskonto4" name="iskonto4" value="{{ old('iskonto4', 0) }}">
                                @error('iskonto4')<div class="form-error">{{ $message }}</div>@enderror
                            </div>

                            <div class="form-group">
                                <label for="iskonto5">İskonto 5</label>
                                <input type="text" id="iskonto5" name="iskonto5" value="{{ old('iskonto5', 0) }}">
                                @error('iskonto5')<div class="form-error">{{ $message }}</div>@enderror
                            </div>

                            <div class="form-group">
                                <label for="iskonto6">İskonto 6</label>
                                <input type="text" id="iskonto6" name="iskonto6" value="{{ old('iskonto6', 0) }}">
