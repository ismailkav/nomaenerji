...
<head>
    ...
    <title>Yeni Fiyat Listesi - NomaEnerji</title>
    ...
    <main class="main-content">
        ...
        <section class="content-section" style="padding: 2rem;">
            <div class="offer-card">
                ...
                <form method="POST" action="{{ route('price-lists.store') }}" id="priceListForm">
                    @csrf
                    ...
                    <div class="offer-header">
                        <div class="offer-header-left">
                            <div class="form-group">
                                ...
                                <div class="input-with-button">
                                    ...
                                    <input id="firm_id" name="firm_id" type="hidden" value="{{ old('firm_id') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="hazirlayan" class="header-input header-input-sm" name="hazirlayan" type="text" value="{{ old('hazirlayan', $hazirlayan) }}">
                            </div>
                        </div>
                        ...
                        <div class="offer-header-right">
                            <div class="form-group">
                                ...
                                <input id="baslangic_tarihi" class="header-input" name="baslangic_tarihi" type="date" value="{{ old('baslangic_tarihi', now()->toDateString()) }}">
                            </div>
                            <div class="form-group">
                                <label for="bitis_tarihi" style="color:#9ca3af;">Bitiş Tarihi:</label>
                                <input id="bitis_tarihi" class="header-input" name="bitis_tarihi" type="date" required value="{{ old('bitis_tarihi') }}">
                            </div>
                        </div>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Ürün seçimi: stok kodu veya açıklamaya çift tıkla
        ...
        if (Array.isArray(oldLines) && oldLines.length) {
            oldLines.forEach(function (l) { addLineRow(l); });
        }
    });
</script>
</body>
