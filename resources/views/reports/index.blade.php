...
<head>
    ...
    <title>Raporlar - NomaEnerji</title>
    ...
    <main class="main-content">
        ...
        <section class="content-section" style="padding: 2rem;">
            <div class="form-page-card">
                <h1 style="font-size:1.4rem;font-weight:600;margin-bottom:0.25rem;">Raporlar</h1>
                <div style="color:#6b7280;font-size:0.9rem;">Bu alan yakında eklenecek.</div>
            </div>
        </section>
    </main>
</div>
